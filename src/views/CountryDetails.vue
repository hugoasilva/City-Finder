  ...
  <div class="text-center">
    ...
    <div class="col-md-8 offset-md-2 text-center pt-4">
      <div class="jumbotron">
        ...
        <br>
        <img v-if="this.countryDetails.data" id="flag" :src="countryDetails.data.flagImageUri" alt="Bandeira">
        <table class="table countryTable">
          <thead>
            <th v-if="this.countryDetails.data" class="bg-primary" colspan="2">{{ countryDetails.data.name }}</th>
          </thead>
